...
public class PullableRecyclerView extends WrapRecyclerView implements Pullable
{
    ...
    public boolean canPullDown()
    {
        ...
        if (0 == count)
        {
            // 没有item的时候也可以下拉刷新
            return true;
        } else if (lm.findViewByPosition(firstVisibleItemPosition).getTop() == 0 && firstVisibleItemPosition == 0)
        {
            // 滑到ListView的顶部了
            return true;
        } else
    ...
    public boolean canPullUp()
    {
        ...
        {
            // 滑到底部了
            if (lm.findViewByPosition(lastVisibleItemPosition - firstVisibleItemPosition) != null
